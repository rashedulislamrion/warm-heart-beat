...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "DearDash delivers food and parcels across campus — fast, friendly and yours. Your campus delivery, delivered with care." },
      { property: "og:site_name", content: "DearDash" },
      { property: "og:title", content: "DearDash — Dear to you. Dashed to you." },
      { property: "og:description", content: "DearDash delivers food and parcels across campus — fast, friendly and yours. Your campus delivery, delivered with care." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "DearDash — Dear to you. Dashed to you." },
      { name: "twitter:description", content: "DearDash delivers food and parcels across campus — fast, friendly and yours. Your campus delivery, delivered with care." },
