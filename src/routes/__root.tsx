...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "পায়রা" },
      { name: "application-name", content: "পায়রা" },
      ...
      { property: "og:title", content: "পায়রা — CU'র নিজস্ব ডেলিভারি প্ল্যাটফর্ম" },
      ...
      { name: "twitter:title", content: "পায়রা — CU'র নিজস্ব ডেলিভারি প্ল্যাটফর্ম" },
